      ...
      <div className="about-me__container">
        <div className="about-me__info">
          <article className="about-me__article">
              ...
              Люблю осваивать что-то новое. Недавно начал кодить. Сейчас заканчиваю курс по веб-разработке. Надеюсь в будущем трудоустроиться в качестве разработчика (если не переведусь в "Н";).
              </p>
          </article>
        ...
        <img src="#" className="about-me__photo" alt="Фотография студента" />
      </div>
    </div>
  );
}
